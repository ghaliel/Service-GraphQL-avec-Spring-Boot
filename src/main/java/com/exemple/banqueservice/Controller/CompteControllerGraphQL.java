package com.exemple.banqueservice.Controller;
...
import com.exemple.banqueservice.dto.CompteRequest;
import com.exemple.banqueservice.dto.TransactionRequest;
...
public class CompteControllerGraphQL {
    ...
    public Compte saveCompte(@Argument CompteRequest compte){
        ...
        try {
            ...
            newCompte.setDateCreation(dateFormat.parse(compte.getDateCreation()));
